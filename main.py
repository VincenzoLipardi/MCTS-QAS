...
sif.run_and_savepkl(evaluation_function=evf.h2, criteria=CRITERIA[0], variable_qubits=4, ancilla_qubits=0, gate_set='continuous', rollout_type=ROTYPE, budget=60, branches=False, roll_out_steps=1, iteration=1, max_depth=MAX_DEPTH, choices=p, epsilon=EPS, stop_deterministic=STOP, ucb=0.2, verbose=False)
